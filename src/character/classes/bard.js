...
class Warrior extends Character{
  constructor(side = "player", charType = "Warrior", level = 1, currentHealth = 40, maxHealth = 40, AP = 4, APRec = 4, power = 10, armor = 20,
    initiative = 15, critChance = 0, critDamage = 2, damageMod = 0, healMod = 0, cdMod = 1, lifesteal = 0, regen = 1,
  ...
  render(){
    Character.prototype.render.call("bard");
