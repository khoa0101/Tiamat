...
class Ranger extends Character{
  constructor(side = "player", charType = "Warrior", level = 1, currentHealth = 35, maxHealth = 35, AP = 4, APRec = 4, power = 15, armor = 20,
    initiative = 16, critChance = 0, critDamage = 2, damageMod = 0, healMod = 0, cdMod = 1, lifesteal = 0, regen = 1,
